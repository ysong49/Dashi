...
public class Restaurant {
	...
	/*
	 * Functionality: Database cannot store Json objects or JsonArray, we have
	 * to convert them to string. e.g. [Chinese, Japanese, Korean] => Chinese,
	 * Japanese, Korean
	 * 
	 */
	...
	/*
	 * Functionality: when we get data from database, data are strings, we have
	 * to convert them to Json objects or jason array. e.g. Chinese, Japanese,
